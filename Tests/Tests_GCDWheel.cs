...
public class Tests_GCDWheel
{
    ...
    private static (bool, bool, bool) GetActionPressStatus(MockAction act)
    {
        var isWeaponSkill = HelperMethods._isWeaponSkill(act.recast_group, act.additional_recast ?? act.recast_group);
        var AddingToQueue = HelperMethods._isAddingToQueue(isWeaponSkill, act.InQueue, act.ElapsedGCD, act.TotalGCD, act.AnimationLock, MockAction.ElapsedCastTime, MockAction.TotalCastTime);
...
public class MockAction
{
    ...
    public const float ElapsedCastTime = 0; //value?
    public const float TotalCastTime = 0; //value?
