...
namespace Tests.Mocks {
    public class LuminaWrapper : IDataManager {
        ...
        public Language Language {
            get => _gameData.Options.DefaultExcelLanguage;
            set => _gameData.Options.DefaultExcelLanguage = value;
        }

        ClientLanguage IDataManager.Language => throw new System.NotImplementedException();

        public GameData GameData => throw new System.NotImplementedException();

        public ExcelModule Excel => throw new System.NotImplementedException();

        public bool HasModifiedGameDataFiles => throw new System.NotImplementedException();
    }
}